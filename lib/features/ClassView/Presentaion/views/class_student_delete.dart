...
class ClassStudentDelete extends StatelessWidget {
  const ClassStudentDelete({super.key, this.onPressed, required this.name});
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text("Delete student", style: AppTextStyles.medium18),
          const Gap(16),
          Text.rich(
            TextSpan(
              children: [
